...
var SMTP_PORT = 465;
var SMTP_USER = "nexentiosoft@gmail.com";
var SMTP_PASS = "irlqsakxfyqelaao";
var TO_EMAIL = "info@mastersmilestudio.com";
var CC_EMAIL = "nexentiosoft@gmail.com";
async function onRequestPost(context2) {
  ...
  try {
    ...
    if (contentType.includes("application/json")) {
      data = await context2.request.json();
    } else if (contentType.includes("application/x-www-form-urlencoded") || contentType.includes("multipart/form-data")) {
      const formData = await context2.request.formData();
      data = Object.fromEntries(formData.entries());
    }
    const patientName = data.fullName || data.name || "\u0130simsiz Ziyaret\xE7i";
    ...
    const patientTreatment = Array.isArray(data.treatments) ? data.treatments.join(", ") : data.treatment || data.treatments || "Genel Muayene / Belirtilmedi";
...
<body>
  <div class="card">
    <div class="header">
      <h1>\u{1F9B7} Master Smile Studio \u2014 Yeni Hasta Talebi</h1>
      <p>Web sitesi \xFCzerinden yeni bir kons\xFCltasyon formu iletildi.</p>
    ...
    <div class="content">
      ...
      <div class="field-group">
        <div class="field-label">\xDClke / Konum</div>
      ...
      ${whatsappLink ? `<div class="cta-container">
              <a href="${whatsappLink}" target="_blank" class="wa-button">
                \u{1F4AC} Hastaya WhatsApp'tan Yan\u0131t Ver
              </a>
            </div>` : ""}
    </div>
    <div class="footer">
      Master Smile Studio Antalya \u2022 Form G\xF6nderim Zaman\u0131: ${(/* @__PURE__ */ new Date()).toLocaleString("tr-TR", { timeZone: "Europe/Istanbul" })}
    </div>
  </div>
</body>
</html>
    ...
    console.error("Contact form submission error:", error3);
    return new Response(
      JSON.stringify({ success: false, error: error3.message || "Failed to send message" }),
      {
        status: 500,
        headers: { ...corsHeaders, "Content-Type": "application/json" }
      }
...
// ../.wrangler/tmp/pages-oBuwlY/functionsRoutes-0.48244019407365557.mjs
var routes = [
  {
