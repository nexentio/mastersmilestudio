...
async function onRequestPost(context2) {
  ...
  try {
    ...
    const formattedDate = (/* @__PURE__ */ new Date()).toLocaleString("tr-TR", { timeZone: "Europe/Istanbul" });
    const htmlBody = `
<!DOCTYPE html>
<html lang="tr">
<head>
          ...
          <tr>
            <td>
              ...
              <h1 style="margin: 0; font-size: 18px; font-weight: 600; color: #ffffff;">
                Yeni Hasta Kons\xFCltasyon Talebi
              </h1>
            </td>
...
// ../.wrangler/tmp/pages-FgWwWL/functionsRoutes-0.17323613721500886.mjs
var routes = [
  {
