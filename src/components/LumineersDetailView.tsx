...
const DICTIONARIES: Record<string, LocaleDictionary> = {
  "en": {
    ...
    "packagesSubtitle": "Ultra-thin 0.2 mm contact lens porcelain veneers placed with zero enamel drilling, no anesthesia, hotel accommodation, and VIP Mercedes transfers in Istanbul.",
    ...
    "faqSubtitle": "Everything you need to know about non-invasive Lumineers, zero tooth preparation, reversibility, optical translucency, and longevity in Istanbul.",
    "stayDuration": "<strong>5 to 7 days in Istanbul.</strong> Precision 3D digital impressions, custom fabrication of ultra-thin feldspathic Lumineers, and adhesive bonding are completed in 1 trip.",
    "visitCount": "<strong>Single 1-visit trip.</strong> You only need to travel once to Istanbul for your complete non-invasive smile makeover.",
