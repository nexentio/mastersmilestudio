...
export default function TreatmentDenturesPackagesSlider() {
  ...
  return (
    <section aria-labelledby="denture-packages-heading" className={styles.wrapper}>
      <div className={styles.container}>
        {/* Header */}
        <div className={styles.head}>
          <span className={styles.badge}>{dict.badge}</span>
          <h2 id="denture-packages-heading" className={styles.title}>
            {dict.title}
          </h2>
        ...
        <div className={styles.mobileContainer}>
          <div className={styles.mobileCardWrapper}>
            <button
              ...
              aria-label="Previous denture package"
            >
              ‹
            </button>
            ...
            <button
              ...
              aria-label="Next denture package"
            >
              ›
            </button>
          </div>
