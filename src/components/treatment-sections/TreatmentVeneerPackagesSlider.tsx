...
export default function TreatmentVeneerPackagesSlider() {
  ...
  return (
    <section aria-labelledby="veneer-packages-heading" className={styles.wrapper}>
      <div className={styles.container}>
        {/* Header */}
        <div className={styles.head}>
          <span className={styles.badge}>{dict.badge}</span>
          <h2 id="veneer-packages-heading" className={styles.title}>
            {dict.title}
          </h2>
        ...
        <div className={styles.mobileContainer}>
          <div className={styles.mobileCardWrapper}>
            <button
              ...
              aria-label="Previous veneer package"
            >
              ‹
            </button>
            ...
            <button
              ...
              aria-label="Next veneer package"
            >
              ›
            </button>
          </div>
