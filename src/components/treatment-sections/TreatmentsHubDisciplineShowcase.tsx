...
const SHOWCASE_DATA: Record<string, HubShowcaseDictionary> = {
  en: {
    ...
    heading: 'Explore Our World-Class Dental Treatments in Antalya',
    subText:
    ...
    gridItems: [
      ...
      },
      {
        ...
        sublinks: [
          ...
          { label: 'Full Ceramic Crowns', href: '/treatments/dental-crowns/full-ceramic-crowns' },
        ],
      },
      {
        id: 'bridge',
        ...
        popularTechniquesLabel: 'Popular Techniques & Subpages:',
        sublinks: [
          { label: 'Traditional Bridges', href: '/treatments/dental-bridges/traditional-bridges' },
          { label: 'Maryland Winged Bridge', href: '/treatments/dental-bridges/maryland-bridges' },
          { label: 'Cantilever Bridges', href: '/treatments/dental-bridges/cantilever-bridges' },
        ],
      },
      {
        id: 'dentures',
      ...
      },
      {
        ...
        sublinks: [
          ...
          { label: 'Gummy Smile Laser', href: '/treatments/cosmetic-dentistry/gummy-smile-treatment' },
  ...
  tr: {
    ...
    heading: 'Antalya’da Dünya Standartlarında Diş Tedavilerimizi Keşfedin',
    subText:
    ...
    gridItems: [
      ...
      },
      {
        ...
        sublinks: [
          ...
          { label: 'Tam Seramik Kaplama', href: '/treatments/dental-crowns/full-ceramic-crowns' },
        ],
      },
      {
        id: 'bridge',
        ...
        popularTechniquesLabel: 'Popüler Teknikler & Alt Sayfalar:',
        sublinks: [
          { label: 'Geleneksel Köprü', href: '/treatments/dental-bridges/traditional-bridges' },
          { label: 'Maryland Kanatlı Köprü', href: '/treatments/dental-bridges/maryland-bridges' },
          { label: 'Balkon (Asma) Köprü', href: '/treatments/dental-bridges/cantilever-bridges' },
        ],
      },
      {
        id: 'dentures',
      ...
      },
      {
        ...
        sublinks: [
          ...
          { label: 'Lazer Pembe Estetik', href: '/treatments/cosmetic-dentistry/gummy-smile-treatment' },
  ...
  de: {
    ...
    heading: 'Entdecken Sie unsere erstklassigen Zahnbehandlungen in Antalya',
    subText:
    ...
    gridItems: [
      ...
      },
      {
        ...
        sublinks: [
          ...
          { label: 'Vollkeramikkronen', href: '/treatments/dental-crowns/full-ceramic-crowns' },
        ],
      },
      {
        id: 'bridge',
        ...
        popularTechniquesLabel: 'Beliebte Verfahren & Unterseiten:',
        sublinks: [
          { label: 'Traditionelle Brücken', href: '/treatments/dental-bridges/traditional-bridges' },
          { label: 'Maryland Klebebrücken', href: '/treatments/dental-bridges/maryland-bridges' },
          { label: 'Freiendbrücken', href: '/treatments/dental-bridges/cantilever-bridges' },
        ],
      },
      {
        id: 'dentures',
      ...
      },
      {
        ...
        sublinks: [
          ...
          { label: 'Laser-Zahnfleischkorrektur', href: '/treatments/cosmetic-dentistry/gummy-smile-treatment' },
  ...
  pl: {
    ...
    heading: 'Odkryj Nasze Zabiegi Stomatologiczne w Antalyi',
    subText:
    ...
    gridItems: [
      ...
      },
      {
        ...
        sublinks: [
          ...
          { label: 'Korony Pełnoceramiczne', href: '/treatments/dental-crowns/full-ceramic-crowns' },
        ],
      },
      {
        id: 'bridge',
        ...
        popularTechniquesLabel: 'Popularne Techniki i Podstrony:',
        sublinks: [
          { label: 'Mosty Tradycyjne', href: '/treatments/dental-bridges/traditional-bridges' },
          { label: 'Mosty Adhezyjne Maryland', href: '/treatments/dental-bridges/maryland-bridges' },
          { label: 'Mosty Wspornikowe', href: '/treatments/dental-bridges/cantilever-bridges' },
        ],
      },
      {
        id: 'dentures',
      ...
      },
      {
        ...
        sublinks: [
          ...
          { label: 'Laserowa Plastyka Dziąseł', href: '/treatments/cosmetic-dentistry/gummy-smile-treatment' },
  ...
  pt: {
    ...
    heading: 'Explore Nossos Tratamentos Odontológicos em Antalya',
    subText:
    ...
    gridItems: [
      ...
      },
      {
        ...
        sublinks: [
          ...
          { label: 'Coroas Cerâmicas Totais', href: '/treatments/dental-crowns/full-ceramic-crowns' },
        ],
      },
      {
        id: 'bridge',
        ...
        popularTechniquesLabel: 'Técnicas e Subpáginas Populares:',
        sublinks: [
          { label: 'Pontes Tradicionais', href: '/treatments/dental-bridges/traditional-bridges' },
          { label: 'Pontes Adesivas Maryland', href: '/treatments/dental-bridges/maryland-bridges' },
          { label: 'Pontes Cantilever', href: '/treatments/dental-bridges/cantilever-bridges' },
        ],
      },
      {
        id: 'dentures',
      ...
      },
      {
        ...
        sublinks: [
          ...
          { label: 'Gengivoplastia a Laser', href: '/treatments/cosmetic-dentistry/gummy-smile-treatment' },
  ...
  es: {
    badge: 'DISCIPLINAS ODONTOLÓGICAS COMPLETAS',
    heading: 'Descubra Nuestros Tratamientos Dentales en Antalya',
    subText:
    ...
    gridItems: [
      ...
      },
      {
        ...
        sublinks: [
          ...
          { label: 'Coronas Completamente Cerámicas', href: '/treatments/dental-crowns/full-ceramic-crowns' },
        ],
      },
      {
        id: 'bridge',
        ...
        popularTechniquesLabel: 'Técnicas y Subpáginas Populares:',
        sublinks: [
          { label: 'Puentes Tradicionales', href: '/treatments/dental-bridges/traditional-bridges' },
          { label: 'Puentes Adhesivos Maryland', href: '/treatments/dental-bridges/maryland-bridges' },
          { label: 'Puentes Cantilever', href: '/treatments/dental-bridges/cantilever-bridges' },
        ],
      },
      {
        id: 'dentures',
      ...
      },
      {
        ...
        sublinks: [
          ...
          { label: 'Gingivoplastia Láser', href: '/treatments/cosmetic-dentistry/gummy-smile-treatment' },
  ...
  ru: {
    ...
    heading: 'Исследуйте наши передовые стоматологические процедуры в Анталье',
    subText:
    ...
    gridItems: [
      ...
      },
      {
        ...
        sublinks: [
          ...
          { label: 'Цельнокерамические коронки', href: '/treatments/dental-crowns/full-ceramic-crowns' },
        ],
      },
      {
        id: 'bridge',
        ...
        popularTechniquesLabel: 'Популярные методики и страницы:',
        sublinks: [
          { label: 'Традиционные мосты', href: '/treatments/dental-bridges/traditional-bridges' },
          { label: 'Мэрилендские мосты', href: '/treatments/dental-bridges/maryland-bridges' },
          { label: 'Консольные мосты', href: '/treatments/dental-bridges/cantilever-bridges' },
        ],
      },
      {
        id: 'dentures',
      ...
      },
      {
        ...
        sublinks: [
          ...
          { label: 'Лазерная коррекция десен', href: '/treatments/cosmetic-dentistry/gummy-smile-treatment' },
