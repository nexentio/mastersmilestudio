...
const HERO_I18N = {
  en: {
    tag: 'TREATMENTS',
    title: 'Dental Cleaning (Scaling & Polishing) in Istanbul, Turkey',
  ...
  tr: {
    tag: 'TEDAVİLERİMİZ',
    title: 'İstanbul Diş Taşı Temizliği (Detertraj & Polisaj)',
  ...
  de: {
    tag: 'BEHANDLUNGEN',
    title: 'Professionelle Zahnreinigung (PZR) in Istanbul, Türkei',
