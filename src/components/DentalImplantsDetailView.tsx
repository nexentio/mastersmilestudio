...
const DETAIL_I18N: Record<string, DetailI18n> = {
  en: {
    whyChooseHeading: 'Why Choose Dental Implants in Antalya?',
    whyChooseIntroLead:
      'Antalya has become a top destination for dental implants due to its world-class healthcare system, highly skilled dental professionals, and ',
    whyChooseIntroLink: 'affordable prices.',
    whyChooseIntroTail: ' Here’s why choosing dental implants in Antalya is a great option:',
    ...
    reason4Title: 'Before - After Dental Implant at Master Smile Studio in Antalya',
    reason4P:
      'Dental implants in Antalya are not just about function; they are designed to blend seamlessly with your natural teeth. Our expert team works to ensure your new smile looks natural, radiant, and beautiful.',
    reason5Title: 'Travel and Treatment in One',
    reason5PText:
      'Antalya is a vibrant world metropolis, offering the perfect mix of culture, history, and modern luxury. You can enjoy a relaxing holiday while receiving top-tier dental treatment. Master Smile Studio offers expert care at a fraction of Western costs. ',
    reason5PLink: 'Contact us today to learn more!',
    typesHeading: 'Types of Dental Implants (Single, Multiple, All-on-4, All-on-6) in Antalya',
    typesIntro:
      'Dental implants come in different types depending on how many teeth are missing and the condition of your jawbone. At Master Smile Studio in Antalya, our oral surgery specialists help you choose the best option for your needs. Here are the most common types:',
    ...
    allOn4Title: 'All-on-4 Dental Implants in Antalya',
    allOn4P:
    ...
    allOn6Title: 'All-on-6 Dental Implants in Antalya',
    allOn6P:
  ...
  tr: {
    whyChooseHeading: 'Neden Antalya’da Diş İmplantı Yaptırmalısınız?',
    whyChooseIntroLead:
      'Antalya, dünya standartlarında sağlık altyapısı, yüksek nitelikli cerrahları ve ',
    ...
    reason4Title: 'Master Smile Studio Antalya’da Öncesi & Sonrası Sonuçlar',
    reason4P:
      'Antalya’da diş implantları sadece işlevsel değil; aynı zamanda doğal dişlerinizle kusursuz bir uyum yakalayacak şekilde estetik olarak tasarlanır. Uzman ekibimiz yeni gülüşünüzün hem son derece doğal hem de büyüleyici görünmesini sağlar.',
    reason5Title: 'Seyahat ve Tedavi Bir Arada',
    reason5PText:
      'Antalya kültür, tarih ve modern konforun kusursuz bir karışımını sunan büyüleyici bir şehirdir. En üst düzey dental tedaviyi alırken aynı zamanda unutulmaz bir tatil deneyimi yaşayabilirsiniz. ',
    reason5PLink: 'Detaylı bilgi için bugün bizimle iletişime geçin!',
    typesHeading: 'Antalya’da Uygulanan Diş İmplantı Türleri (Tek, Çoklu, All-on-4, All-on-6)',
    typesIntro:
    ...
    allOn4Title: 'Antalya’da All-on-4 Diş İmplantı',
    allOn4P:
    ...
    allOn6Title: 'Antalya’da All-on-6 Diş İmplantı',
    allOn6P:
  ...
  pl: {
    whyChooseHeading: 'Dlaczego warto wybrać implanty zębowe w Antalyi?',
    whyChooseIntroLead:
      'Antalya stał się wiodącym kierunkiem turystyki stomatologicznej na świecie dzięki doskonałemu systemowi opieki medycznej, wybitnym chirurgom oraz ',
    whyChooseIntroLink: 'przystępnym cenom.',
    whyChooseIntroTail: ' Oto dlaczego warto wybrać implanty zębowe w Antalyi:',
    ...
    reason4Title: 'Wyniki przed i po w Master Smile Studio w Antalyi',
    reason4P:
      'Implanty zębowe w Antalyi to nie tylko funkcjonalność żucia; są one projektowane tak, aby idealnie współgrały z Twoimi naturalnymi zębami i rysami twarzy.',
    reason5Title: 'Podróż i leczenie w jednym',
    reason5PText:
      'Antalya to tętniąca życiem metropolia oferująca idealne połączenie kultury, historii i nowoczesnego komfortu. Możesz cieszyć się niezapomnianymi wakacjami podczas leczenia stomatologicznego na najwyższym poziomie. ',
    reason5PLink: 'Skontaktuj się z nami już dziś!',
    typesHeading: 'Rodzaje implantów zębowych w Antalyi (pojedyncze, wielokrotne, All-on-4, All-on-6)',
    typesIntro:
    ...
    allOn4Title: 'Implanty All-on-4 w Antalyi',
    allOn4P:
    ...
    allOn6Title: 'Implanty All-on-6 w Antalyi',
    allOn6P:
  ...
  de: {
    whyChooseHeading: 'Warum Zahnimplantate in Antalya wählen?',
    whyChooseIntroLead:
      'Antalya ist dank seines erstklassigen Gesundheitssystems, erfahrener Chirurgen und ',
    ...
    reason4P:
      'Zahnimplantate in Antalya verbinden perfekte Kaufunktion mit höchster Ästhetik für ein strahlendes, natürliches Lächeln.',
    reason5Title: 'Reise und Behandlung kombiniert',
    reason5PText:
      'Genießen Sie einen erholsamen Aufenthalt in der Weltmetropole Antalya, während Sie Ihre Zähne behandeln lassen. ',
    reason5PLink: 'Kontaktieren Sie uns noch heute!',
    typesHeading: 'Arten von Zahnimplantaten (Einzelzahn, Mehrere, All-on-4, All-on-6) in Antalya',
    typesIntro:
    ...
    allOn4Title: 'All-on-4 Zahnimplantate in Antalya',
    allOn4P:
    ...
    allOn6Title: 'All-on-6 Zahnimplantate in Antalya',
    allOn6P:
  ...
  pt: {
    whyChooseHeading: 'Por Que Escolher Implantes Dentários em Antalya?',
    whyChooseIntroLead:
      'Antalya tornou-se um dos principais destinos para implantes dentários devido ao seu sistema de saúde de excelência e ',
    whyChooseIntroLink: 'preços acessíveis.',
    whyChooseIntroTail: ' Veja por que escolher implantes em Antalya é a melhor opção:',
    ...
    reason5PText:
      'Desfrute de uma estadia inesquecível em Antalya enquanto renova completamente o seu sorriso. ',
    reason5PLink: 'Fale conosco hoje mesmo!',
    typesHeading: 'Tipos de Implantes Dentários em Antalya (Unitário, Múltiplos, All-on-4, All-on-6)',
    typesIntro:
    ...
    allOn4Title: 'Implantes All-on-4 em Antalya',
    allOn4P:
    ...
    allOn6Title: 'Implantes All-on-6 em Antalya',
    allOn6P:
  ...
  es: {
    whyChooseHeading: '¿Por Qué Elegir Implantes Dentales en Antalya?',
    whyChooseIntroLead:
      'Antalya es un destino líder mundial en implantes dentales gracias a su avanzada tecnología médica y ',
    whyChooseIntroLink: 'precios accesibles.',
    whyChooseIntroTail: ' Razones principales para elegir Master Smile Studio en Antalya:',
    ...
    reason5PText:
      'Disfrute de los atractivos históricos de Antalya mientras transforma su sonrisa con total comodidad. ',
    reason5PLink: '¡Contáctenos hoy mismo!',
    typesHeading: 'Tipos de Implantes Dentales en Antalya (Unitario, Múltiples, All-on-4, All-on-6)',
    typesIntro:
    ...
    allOn4Title: 'Implantes All-on-4 en Antalya',
    allOn4P:
    ...
    allOn4LinkText: 'implantes All-on-4.',
    allOn6Title: 'Implantes All-on-6 en Antalya',
    allOn6P:
  ...
  ru: {
    whyChooseHeading: 'Почему стоит выбрать имплантацию зубов в Анталье?',
    whyChooseIntroLead:
      'Анталья стал мировым центром стоматологического туризма благодаря передовой медицине и ',
    whyChooseIntroLink: 'доступным ценам.',
    whyChooseIntroTail: ' Главные преимущества выбора Master Smile Studio в Анталье:',
    ...
    reason4P:
      'Имплантаты в Анталье дарят не только уверенное жевание, но и великолепную естественную улыбку.',
    reason5Title: 'Путешествие и лечение в одной поездке',
    reason5PText:
      'Совместите первоклассное лечение с незабываемым отдыхом в великолепном Анталье. ',
    reason5PLink: 'Свяжитесь с нами сегодня!',
    typesHeading: 'Виды зубных имплантатов в Анталье (Одиночные, Множественные, All-on-4, All-on-6)',
    typesIntro:
    ...
    allOn4Title: 'Имплантация All-on-4 в Анталье',
    allOn4P:
    ...
    allOn6Title: 'Имплантация All-on-6 в Анталье',
    allOn6P:
...
export default function DentalImplantsDetailView() {
  ...
  return (
    <div className={styles.pageWrapper}>
        ...
        <div className={styles.container}>
          ...
          <div className={styles.mainVideoWrap}>
            <iframe
              ...
              title="Dental Implants in Antalya Procedure Video"
      ...
      {/* 3. WHY CHOOSE DENTAL IMPLANTS IN ANTALYA */}
        ...
        <div className={styles.container}>
          ...
          <div className={styles.mainVideoWrap}>
            <iframe
              ...
              title="Why Choose Dental Implants in Antalya Video"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
              allowFullScreen
            />
          </div>
      ...
      <section aria-labelledby="types-implants-heading" className={styles.introSection}>
        <div className={styles.container}>
          ...
          <div className={styles.mainVideoWrap}>
            <iframe
              src="https://www.youtube.com/embed/haSWVr2smMM"
              title="Types of Dental Implants in Antalya Video"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
              allowFullScreen
            />
          </div>
          ...
          <div className={styles.mainVideoWrap}>
            <iframe
              src="https://www.youtube.com/embed/eiTTit9PLrQ"
              title="All-on-6 Dental Implants in Antalya Video"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
              allowFullScreen
            />
          </div>
