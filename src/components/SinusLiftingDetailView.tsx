  ...
  en: {
    ...
    packages: [
      ...
      },
      {
        ...
        price: { USD: '$1,950', EUR: '€1,790', GBP: '£1,550' }
      },
      {
        ...
        price: { USD: '$3,850', EUR: '€3,490', GBP: '£2,990' }
      },
      {
        ...
        price: { USD: '$5,950', EUR: '€5,450', GBP: '£4,690' }
      }
    ],
...
['de', 'pl', 'pt', 'es', 'ru'].forEach(loc => {
  DICTIONARIES[loc] = {
    ...DICTIONARIES.en,
    packagesTitle: loc === 'de' ? 'Sinuslift & Knochenaufbau Pakete & Währungsrechner'
      : loc === 'pl' ? 'Pakiety Podniesienia Dna Zatok (Sinus Lift) i Kalkulator'
      : loc === 'pt' ? 'Pacotes de Sinus Lift e Enxerto Ósseo com Calculadora'
      : loc === 'es' ? 'Paquetes de Elevación de Seno y Regeneración Ósea'
      : 'Пакеты Синус-Лифтинга и Наращивания Кости с Калькулятором',
    packagesSubtitle: loc === 'de' ? 'All-inclusive Sinuslift- und Knochenaufbau-Pakete mit Geistlich Bio-Oss (Schweiz), Botiss und Straumann.'
      : loc === 'pl' ? 'Kompleksowe pakiety sinus lift i regeneracji kości z certyfikowanym szwajcarskim Geistlich Bio-Oss i Straumann.'
      : loc === 'pt' ? 'Pacotes completos de elevação do seio maxilar e enxerto ósseo com Geistlich Bio-Oss suíço e Straumann.'
      : loc === 'es' ? 'Soluciones integrales de elevación de seno maxilar e injerto óseo con Geistlich Bio-Oss suizo y Straumann.'
      : 'Комплексные программы синус-лифтинга и костной пластики на основе Geistlich Bio-Oss (Швейцария) и Straumann.',
