          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', textAlign: 'left' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.35rem' }}>
                ...
                />
                <span style={{ fontSize: '0.68rem', fontWeight: 700, color: '#e4e4e7', textTransform: 'uppercase', letterSpacing: '0.04em' }}>
                  {t('customerService.badge')}
                </span>
              </div>
              <span style={{ fontSize: '0.82rem', fontWeight: 600, color: '#ffffff', lineHeight: 1.25 }}>
