...
import styles from './PfmCrownsDetailView.module.css';
...
const DICTIONARIES: Record<string, LocaleDictionary> = {
  "en": {
    "packagesTitle": "Metal Porcelain (PFM) & Ceramic Dental Crown Packages",
    "packagesSubtitle": "All-inclusive smile makeover and single crown packages using certified German PFM and Swiss Ivoclar E-Max with hotel and VIP transfers.",
    ...
    "packages": [
      {
        ...
        "included": [
          ...
          "Custom shade matching for natural posterior blending",
      ...
      },
      {
        ...
        "included": [
          ...
          "High fracture resistance for extreme chewing forces",
    ...
    "faqs": [
      ...
      },
      {
        ...
        "a": [
          "We strictly refuse low-cost generic copies. We use 100% genuine medical-grade blanks from global dental leaders: German Amman-Girrbach, Vita, and Japanese Noritake Katana multi-layer zirconia (1200+ MPa), as well as Swiss Ivoclar Vivadent IPS e.max lithium disilicate and biocompatible certified dental alloys.",
      ...
      },
      {
        ...
        "a": [
          "We provide a comprehensive warranty on all crown restorations: a lifetime structural guarantee on monolithic zirconia against fracture or breakage, and a 10-year warranty on PFM and Swiss Ivoclar E-Max restorations.",
      ...
      },
      {
        ...
        "a": [
          "Depending on your oral anatomy and aesthetic goals, options include: 1) Monolithic Zirconia Crowns for maximum durability and color masking, 2) Swiss Ivoclar E-Max Veneers for unmatched natural translucency, 3) Metal Porcelain Crowns (PFM) for budget-friendly posterior strength, and 4) In-Office Laser Teeth Whitening."
        ]
      },
      {
      ...
      {
        "q": "What is the expected lifespan of Metal Porcelain (PFM) crowns?",
        "a": [
          "With proper oral hygiene, regular dental checkups, and nighttime bruxism protection (if you grind your teeth), high-quality PFM crowns typically last 15 to 20+ years."
        ]
      },
      {
        "q": "How much tooth structure is reduced for crowns versus veneers?",
        "a": [
          "Laminate veneers require only 0.3 to 0.7 mm of front enamel reduction. Full dental crowns require 1.0 to 1.5 mm of circumferential reduction all around the tooth to create space for high-strength metal-ceramic walls."
        ]
      },
      {
      ...
      },
      {
        ...
        "a": [
          "Laminate veneers are ultra-thin (0.3–0.5 mm) custom porcelain shells bonded only to the front tooth surface; composite veneers are hand-layered resin materials with a shorter lifespan (4–7 years); zirconia and PFM crowns are full 360-degree high-strength caps that fully encase damaged, discolored, or heavily filled teeth for maximum longevity."
        ]
      }
    ]
  },
  "tr": {
    "packagesTitle": "Metal Destekli Porselen (PFM) Diş Kaplama Paketleri",
    "packagesSubtitle": "Alman tıbbi alaşım altyapı ve estetik porselen, otel konaklaması ve VIP transfer dahil her şey dahil kuron paketleri.",
...
export default function PfmCrownsDetailView() {
  ...
  return (
    <div className={styles.wrapper}>
      ...
      <section aria-labelledby="pfm-packages-heading" className={styles.packagesSection}>
        <div className={styles.container}>
          <div className={styles.packagesHeader}>
            <h2 id="pfm-packages-heading" className={styles.packagesTitle}>
              {d.packagesTitle}
            </h2>
      ...
      <section aria-labelledby="pfm-faq-heading" className={styles.faqSection}>
        <div className={styles.faqContainer}>
          <div className={styles.faqHeader}>
            <h2 id="pfm-faq-heading" className={styles.faqTitle}>
              {d.faqTitle}
            </h2>
              ...
              return (
                <div key={fIdx} className={styles.faqItem}>
                  <button
                    ...
                    aria-controls={`pfm-faq-ans-${fIdx}`}
                  >
                  ...
                  {isOpen && (
                    <div id={`pfm-faq-ans-${fIdx}`} className={styles.faqAnswer} role="region">
                      {faq.a.map((par, pIdx) => (
      ...
      <div id="contact">
        <TreatmentInteractiveQuoteForm defaultTreatment="PFM Crowns" />
      </div>
    </div>
  );
}
