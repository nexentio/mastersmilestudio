...
const DICTIONARIES: Record<string, LocaleDictionary> = {
  "en": {
    ...
    "packagesSubtitle": "Conservative fixed bridge restorations with ultra-thin zirconia or ceramic wings, luxury accommodation, and VIP transfers in Antalya.",
    ...
    "faqSubtitle": "Clinical guidance on minimal-prep resin-bonded bridges, adhesive longevity, anterior tooth replacement, and maintenance in Antalya.",
