...
const DICTIONARIES: Record<string, LocaleDictionary> = {
  "en": {
    ...
    "packagesSubtitle": "Single-sided anchor fixed bridge restorations with high-strength German zirconia or Swiss E-Max, luxury hotel accommodation, and VIP transfers in Antalya.",
    ...
    "faqSubtitle": "Clinical guidance on single-abutment cantilever bridges, biting force dynamics, natural tooth preservation, and longevity in Antalya.",
    ...
    "packages": [
      ...
      },
      {
        ...
        "included": [
          ...
          "4-Star Luxury Hotel Stay in Antalya (5 Nights)",
      ...
      },
      {
        ...
        "included": [
          ...
          "5-Star Luxury Hotel Accommodation with Breakfast in Antalya (6 Nights)",
