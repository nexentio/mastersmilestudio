...
import styles from './AllOnSixImplantDetailView.module.css';
...
export default function AllOnSixImplantDetailView() {
  ...
  return (
    <div className={styles.wrapper}>
      ...
      <section aria-labelledby="allon6-intro-heading" className={styles.introSection}>
        <div className={styles.container}>
          <h2 id="allon6-intro-heading" className={styles.introHeading}>
            {d.introTitle}
          </h2>
      ...
      <section aria-labelledby="allon6-materials-heading" className={styles.materialsSection}>
        <div className={styles.container}>
          <div className={styles.materialsHeader}>
            <h2 id="allon6-materials-heading" className={styles.materialsTitle}>
              {d.materialsTitle}
            </h2>
      ...
      <section aria-labelledby="allon6-packages-heading" className={styles.packagesSection}>
        <div className={styles.container}>
          <div className={styles.packagesHeader}>
            <h2 id="allon6-packages-heading" className={styles.packagesTitle}>
              {d.packagesTitle}
            </h2>
      ...
      <section aria-labelledby="allon6-faq-heading" className={styles.faqSection}>
        <div className={styles.faqContainer}>
          <div className={styles.faqHeader}>
            <h2 id="allon6-faq-heading" className={styles.faqTitle}>
              {d.faqTitle}
            </h2>
            <p className={styles.faqSubtitle}>{d.faqSubtitle}</p>
          </div>

          {/* CLINICAL ALL-ON-6 FAQS (10 QUESTIONS) */}
