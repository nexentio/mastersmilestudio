  ...
  'simon-cowell-teeth-before-and-after': {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: {
          en: 'While Beverly Hills dentists charge premium fees per tooth, Master Smile Studio in Antalya provides genuine Swiss Ivoclar E-Max veneers with all-inclusive VIP packages in all-inclusive packages including 5-star hotel and VIP chauffeur.',
...
export function getBlogDetailBySlug(slug: string): BlogDetailArticle {
  ...
  if (slug === SIMON_BAKER_ARTICLE.slug) {
    return SIMON_BAKER_ARTICLE;
  }
